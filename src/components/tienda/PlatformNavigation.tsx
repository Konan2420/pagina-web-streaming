        ...
        <div className="pt-5 sm:pt-6">
          ...
          <div className="relative">
            <div
              ...
              className={cn(
                "flex touch-pan-x gap-2 overflow-x-auto pb-2 scrollbar-none select-none",
                categoryScroll.isDragging ? "cursor-grabbing" : "cursor-grab",
              )}
              role="tablist"
          ...
          <div className="catalog-platform-grid mt-4">
            {visiblePlatformShortcuts.map((platform) => (
              <button
                key={platform.label}
                type="button"
