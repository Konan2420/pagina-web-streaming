/**
 * Landing pages por plataforma: contenido indexable orientado a búsquedas
 * del tipo "cuenta netflix precio", "plan disney+ barato", etc.
 */
...
export const platformPages: PlatformPage[] = [
  {
    ...
    description:
      "Accede al catálogo completo de Netflix en calidad 4K UHD con un perfil propio. Activación el mismo día, sin permanencia y con soporte por WhatsApp durante toda la vigencia del plan.",
    includes: [
  ...
  },
  {
    ...
    description:
      "Disney, Pixar, Marvel, Star Wars, National Geographic y Star en una sola cuenta completa durante un año entero. Entrega inmediata tras confirmar el pago.",
    includes: [
  ...
  },
  {
    ...
    description:
      "Series originales de HBO, cine de Warner Bros y estrenos DC en un perfil HBO Max propio por 30 días, con activación rápida y garantía.",
    includes: [
  ...
  },
  {
    ...
    description:
      "Series originales de Amazon, cine y contenido exclusivo con un perfil Prime Video por 30 días. Precio fijo, sin cargos recurrentes.",
    includes: [
  ...
  },
  {
    ...
    description:
      "Música sin anuncios, descargas offline y calidad alta durante 30 días. Activación el mismo día y sin permanencia.",
    includes: [
  ...
  },
  {
    ...
    description:
      "Elige tres plataformas de streaming y paga menos que contratándolas por separado. Una sola activación, un solo soporte y una sola fecha de renovación.",
    includes: [
