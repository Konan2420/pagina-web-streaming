...
import { A as invariant, D as resolveManifestCssLink, E as resolveManifestAssetLink, F as isResolvedRedirect, O as _getRenderedMatches, P as isRedirect, R as rootRouteId, T as getStylesheetHref, a as isSsrResponse, c as stripSsrResponseBody, f as RouterProvider, i as disposeSsrResponseDetached, k as executeRewriteInput, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, w as getScriptPreloadAttrs, z as isNotFound } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { _ as safeObjectMerge, a as X_TSS_RAW_RESPONSE, f as getResponse, g as runWithStartContext, h as requestHandler, i as TSS_SERVER_FUNCTION, l as flattenMiddlewares, m as getStartOptions, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, p as getStartContext, r as TSS_FORMDATA_CONTEXT, s as createNullProtoObject, t as FrameType } from "./createServerFn-CVho-diU.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DnSFSpuJ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ByOUPHuF.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cb8Rf6_T.mjs"),
		import("./start-CExZr6Jm.mjs"),
