...
import { $ as GraduationCap, G as Layers, Mt as AppWindow, N as Music, O as Play, i as Users, m as Sparkles, n as Zap, nt as Gamepad2, q as Key, rt as Flame, s as Tv, tt as Gift, z as Mail } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/data-HRSO5WdQ.js
var data_HRSO5WdQ_exports = /* @__PURE__ */ __exportAll({
	a: () => categories,
	c: () => getAvatarUrl,
	i: () => buildWhatsAppMessage,
	l: () => products,
	n: () => buildCartWhatsAppMessage,
	o: () => data_exports,
	r: () => buildProductInquiryWhatsAppMessage,
	s: () => estadoStyles,
	t: () => WA_NUMBER
});
var data_exports = /* @__PURE__ */ __exportAll$1({
	WA_NUMBER: () => WA_NUMBER,
	buildCartWhatsAppMessage: () => buildCartWhatsAppMessage,
	buildProductInquiryWhatsAppMessage: () => buildProductInquiryWhatsAppMessage,
	buildWhatsAppMessage: () => buildWhatsAppMessage,
	catalogPriceById: () => catalogPriceById,
	categories: () => categories,
	estadoStyles: () => estadoStyles,
	getAvatarUrl: () => getAvatarUrl,
	products: () => products
});
var WA_NUMBER = "51970097715";
var categories = [
	{
		id: "todo",
		label: "Todo",
...
var common = {
	descripcion_larga: `🔒 Producto de acceso digital. No compartir credenciales.
...
var catalogPriceById = Object.fromEntries(products.map((p) => [p.id, p.price]));
var estadoStyles = {
...
function buildWhatsAppMessage(product, opts) {
	...
	if (lowerName.includes("netflix")) platformHint = " — Perfil propio en calidad 4K UHD";
	else if (lowerName.includes("disney")) platformHint = " — Cuenta completa sin interrupciones";
	else if (lowerName.includes("hbo")) platformHint = " — Perfil estándar con contenido Max";
	else if (lowerName.includes("prime")) platformHint = " — Perfil propio con envío Prime incluido";
	else if (lowerName.includes("spotify")) platformHint = " — Escucha sin anuncios y modo offline";
	else if (product.category === "combos") platformHint = " — Combo de plataformas seleccionadas";
	...
	if (opts?.extraLine) message += `\n${opts.extraLine}`;
	return message;
}
function buildProductInquiryWhatsAppMessage(product) {
...
//#endregion
export { categories as a, getAvatarUrl as c, buildWhatsAppMessage as i, products as l, buildCartWhatsAppMessage as n, data_HRSO5WdQ_exports as o, buildProductInquiryWhatsAppMessage as r, estadoStyles as s, WA_NUMBER as t };
