...
import { m as upsertProduct, r as deleteProduct } from "./admin.functions-Z_XiCNsk.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/productos-DVRDObM2.js
...
function ProductsManagement() {
	...
	const handleImageUpload = async (e) => {
		...
		try {
			...
			const { data: signedData, error: signedUrlError } = await supabase.storage.from("product-images").createSignedUrl(filePath, 3600 * 24 * 365);
