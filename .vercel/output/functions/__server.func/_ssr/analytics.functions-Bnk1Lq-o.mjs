import { c as createServerFn, v as setResponseHeader } from "./createServerFn-CVho-diU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/analytics.functions-Bnk1Lq-o.js
...
var getAnalyticsDashboard = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).handler(getAnalyticsDashboard_createServerFn_handler, async ({ context }) => {
	...
	const dayAgo = (/* @__PURE__ */ new Date(now.getTime() - 1440 * 60 * 1e3)).toISOString();
	const weekAgo = (/* @__PURE__ */ new Date(now.getTime() - 10080 * 60 * 1e3)).toISOString();
	const monthAgo = (/* @__PURE__ */ new Date(now.getTime() - 720 * 60 * 60 * 1e3)).toISOString();
