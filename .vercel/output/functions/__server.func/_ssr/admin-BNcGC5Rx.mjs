...
import { d as AdminLayout, m as adminStatsQueryOptions, p as Route$16 } from "./router-CZAAJbb_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-BNcGC5Rx.js
var import_jsx_runtime = require_jsx_runtime();
function AdminDashboard() {
	const { data: stats } = useSuspenseQuery(adminStatsQueryOptions);
	const { isAdmin } = Route$16.useRouteContext();
